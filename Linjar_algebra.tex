...
\pagebreak
\section*{Kapitel 5: Vektorprodukt}

\setlength\arraycolsep{3pt}

\texttt{\tskcol{5.1~~~a) (s. 89)}}
\begin{quotation}
	\noindent
	\[e_1\times e_3=-e_2\]
	\[e_3 \times e_2=-e_1\]
	\\
	\textbf{Svar:} $-e_2$ och $-e_1$
\end{quotation}
...
\begin{quotation}
	...
	\begin{align*}
	A=&\frac{1}{2}\left|(2,4,3)\times(3,0,1)|=
...
\begin{quotation}
	...
	\[|\hat{e}_1
	|=1 \Leftrightarrow
	\sqrt{k^2+k^2+k^2}=1 \Leftrightarrow
	3k^2=1 \Leftrightarrow
	k=\pm\frac{1}{\sqrt{3}}\]
	...
	&\frac{1}{\sqrt{6}}\left(\left|\begin{array}{cc}
	1 &-1 \\
	-1& 0 
	\end{array}\right|,
	-\left|\begin{array}{cc}
	...
	\[\pi:\frac{1}{\sqrt{3}}\hat{x}_1-\frac{4}{\sqrt{6}}\hat{x}_3=0 \Leftrightarrow
	\hat{x}_1-2\sqrt{2}\hat{x}_3=0\]
	\\ \\
	\textbf{Svar:} $\hat{e}_1=\frac{1}{\sqrt{3}}(1,1,-1)$, $\hat{e}_2=\frac{1}{\sqrt{2}}(1,-1,0)$, $\hat{e}_3=-\frac{1}{\sqrt{6}}(1,1,2)$ och $\pi:\hat{x}_1-2\sqrt{2}\hat{x}_3=0$
\end{quotation}
...
\begin{quotation}
	...
	Låt $u=(x,y,z)$.
	\begin{align*}
	&(x,y,z)\times(1,a,-1)=(1,2,3) \Leftrightarrow \\ \Leftrightarrow
	&\left(\left|\begin{array}{cc}
	y & z \\
	a &-1 
	\end{array}\right|,
	...
	x & y \\
	1 & a
	\end{array}\right|\right)=(1,2,3) \Leftrightarrow \\ \Leftrightarrow
	&(-y-az,-(-x-z),ax-y)=(1,2,3) \Leftrightarrow \\ \Leftrightarrow
	&\begin{cases}
	-y-az=1 \\
	x+z=2 \\
	ax-y=3
...
\pagebreak
\section*{Kapitel 6: Rummet $\mathbb{R}^n$}

\texttt{\tskcol{6.2~~~d) (s.)}}
\begin{quotation}
	\noindent
	\begin{align*}
	&x_1(1,2,2,0)+x_2(2,-1,0,2)+x_3(2,0,-1,-2)+x_4(0,2,-2,1)=0 \Leftrightarrow \\ \Leftrightarrow
	&(x_1+2x_2+2x_3,2x_1-x_2+2x_4,2x_1-x_3-2x_4,2x_2-2x_3+x_4)=0 \Leftrightarrow \\ \Leftrightarrow
	&\begin{cases}
	x_1+2x_2+2x_3=0 \\
	2x_1-x_2+2x_4=0 \\
	2x_1-x_3-2x_4=0 \\
	...
	\end{align*}
	\\
	\textbf{Svar:} Vektorerna är linjärt oberoende
\end{quotation}

\pagebreak
\section*{Kapitel 7: Matriser}
...
\begin{quotation}
	...
	\end{array}\right)\]
	\begin{align*}
	&D_{11}=\left|\begin{array}{cc}
	1 &-1 \\
	3 & 0
	\end{array}\right|=3, 
	&D_{12}=\left|\begin{array}{cc}
	4 &-1 \\
	2 & 0
	\end{array}\right|=2,
	&D_{13}=\left|\begin{array}{cc}
	4 & 1 \\
	2 & 3
	\end{array}\right|=10, \\
	&D_{21}=\left|\begin{array}{cc}
	2 & 0 \\
	3 & 0
	\end{array}\right|=0, 
	&D_{22}=\left|\begin{array}{cc}
	1 & 0 \\
	2 & 
	\end{array}\right|=0,
	&D_{23}=\left|\begin{array}{cc}
	1 & 2 \\
	2 & 3
	\end{array}\right|=-1, \\
	&D_{31}=\left|\begin{array}{cc}
	2 & 0 \\
	1 &-1
	\end{array}\right|=-2, 
	&D_{32}=\left|\begin{array}{cc}
	1 & 0 \\
	4 &-1
	\end{array}\right|=-1,
	&D_{33}=\left|\begin{array}{cc}
	1 & 2 \\
	4 & 1
	\end{array}\right|=-7, \\
	\end{align*}
	...
	\frac{1}{1*3-2*2}\left(\begin{array}{ccc}
	3 & 0 &-2 \\
	-2& 0 & 1 \\
	10& 1 &-7
	\end{array}\right)=
...
\begin{quotation}
	...
	4 & 5 & 6 \\
	7 & 8 & 9
	\end{array}\right) \Leftrightarrow \\ \Leftrightarrow
	&\left(\begin{array}{ccc}
	a+d+g & b+e+h & c+f+i \\
	a+g & b+h & c+i \\
	d+g & e+h & f+i
